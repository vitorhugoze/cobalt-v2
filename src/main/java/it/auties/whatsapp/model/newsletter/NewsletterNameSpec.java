...
public class NewsletterNameSpec {
    ...
    public static void encode(NewsletterName protoInputObject, ProtobufOutputStream protoOutputStream) {
        if (protoInputObject == null) {
            return;
        }
    ...
    public static NewsletterName decode(byte[] protoInputObject) {
        if (protoInputObject == null) {
            return null;
        }
    ...
    public static int sizeOf(NewsletterName protoInputObject) {
        if (protoInputObject == null) {
            return 0;
        }
