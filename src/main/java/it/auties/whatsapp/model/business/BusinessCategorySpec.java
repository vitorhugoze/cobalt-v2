...
public class BusinessCategorySpec {
    ...
    public static void encode(BusinessCategory protoInputObject, ProtobufOutputStream protoOutputStream) {
        if (protoInputObject == null) {
            return;
        }
    ...
    public static BusinessCategory decode(byte[] protoInputObject) {
        if (protoInputObject == null) {
            return null;
        }
    ...
    public static int sizeOf(BusinessCategory protoInputObject) {
        if (protoInputObject == null) {
            return 0;
        }
